const madLibsArray = [
    {
        question: `${cast.name[0]} starred in ${title}.`,
        answer: true,
        movieId: id,
    },
    {
        question: `${title}'s cast included ${cast.name[0]} .`,
        answer: true,
        movieId: id,
    },
    {
        question: `${title} was released on ${release_date}.`,
        answer: true,
        movieId: id,
    },
    {
        question: `${release_date} was the release date of ${title}.`,
        answer: true,
        movieId: id,
    },
    {
        question: `${overview} describes what ${title} is about.`,
        answer: true,
        movieId: id,
    },
    {
    ...
    {
        question: `${title}'s plot used to described as ${changes.items.original_value} genre.`,
        answer: true,
        movieId: id,
    },
    {
